...
2. `docs/project/ERROR_LOG.md`
3. `docs/project/DECISIONS.md`
4. `docs/team/CEO_OS.md`
5. `docs/team/TEAM_LEARNINGS.md`

## Estructura clave
- `docs/team/` roles del equipo y protocolos operativos.
...
- `10xteam.com.mx/` hub raiz con enrutamiento comercial hacia dev y growth.
- `dev.10xteam.com.mx/` unidad de negocio de desarrollo (sitio actual, oferta congelada).
- `growth.10xteam.com.mx/` nueva unidad de prospeccion/plataforma (wizard + whitelabel).
